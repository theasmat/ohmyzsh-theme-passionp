...
2. copy theme: ```cp ./ohmyzsh-theme-passionp/passion.zsh-theme ~/.oh-my-zsh/themes/passion.zsh-theme```;
...
* see also: [#12](https://github.com/theasmat/ohmyzsh-theme-passionp/issues/12);
...
* see also: [#13](https://github.com/theasmat/ohmyzsh-theme-passionp/issues/13);

##### Centos 7, shell exit

* may caused by [set timer to zsh prompt](https://github.com/theasmat/ohmyzsh-theme-passionp/blob/8f71c43c2df91810249ab00ff40fc4ca63207467/passion.zsh-theme#L197-L208);
* see also: [#4](https://github.com/theasmat/ohmyzsh-theme-passionp/issues/4);
